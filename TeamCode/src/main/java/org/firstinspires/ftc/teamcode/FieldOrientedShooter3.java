...
@Disabled
@TeleOp(name="FieldOrientedShooter3", group="Linear OpMode")
public class FieldOrientedShooter3 extends LinearOpMode {
    ...
    // Placeholder motor 2
    private DcMotor placeholderMotor2 = null;
    ...
    // Variable for toggling the placeholder motor
    ...
    public void runOpMode() {
        ...
        intakeMotor.setDirection(DcMotorSimple.Direction.FORWARD); // Or REVERSE if needed
        ...
        while (opModeIsActive()) {
            ...
            // --- Placeholder Motor Toggle Control ---
            ...
            if (placeholderMotorActive) {
                placeholderMotor.setPower(1.0);
            } else {
            ...
            telemetry.addData("Placeholder Motor", placeholderMotor.getPower());
            telemetry.update();
        }
    }
