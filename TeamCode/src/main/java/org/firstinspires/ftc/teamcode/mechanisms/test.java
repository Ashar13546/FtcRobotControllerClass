...
public class test extends LinearOpMode {
    ...
    public static double POSITION_0_RETRACTED = 0;   // Lowest Position
    public static double POSITION_1_MID = 0.45;      // Mid-range position
    public static double POSITION_2_MAX = 0.87;      // Highest Position
